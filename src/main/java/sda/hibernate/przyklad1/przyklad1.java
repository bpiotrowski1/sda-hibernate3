...
public class przyklad1 {
    ...
    public static void main(String[] arg) {
        ...
        Uzytkownik pobranyRekord = (Uzytkownik)session.createQuery("from Uzytkownik WHERE id=:id").setParameter("id",5L).getSingleResult();
        Uzytkownik pobranyRekord2 = session.createQuery("from Uzytkownik WHERE id=:id", Uzytkownik.class).setParameter("id",63L).getSingleResult();
